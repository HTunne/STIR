...
class ProjDataInfoBlocksOnCylindrical: public ProjDataInfo
{
private:
  typedef ProjDataInfo base_type;
  typedef ProjDataInfoBlocksOnCylindrical self_type;
...
private:
  ...
  */
  ...
  virtual void
  find_cartesian_coordinates_of_detection(CartesianCoordinate3D<float>& coord_1,
...
#include "stir/ProjDataInfoBlocksOnCylindrical.inl"
